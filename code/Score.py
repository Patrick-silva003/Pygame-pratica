...
class Score:
    ...
    def show(self):
        ...
        pygame.mixer_music.play(-1)
        self.window.blit(source=self.surf, dest=self.rect)
        self.score_text(60, 'TOP 10 SCORE', C_YELLOW, SCORE_POS['Title'])
        self.score_text(30, 'NAME     SCORE           DATE      ', C_YELLOW, SCORE_POS['Label'])
        db_proxy = DBProxy('DBScore')
        ...
        for player_score in list_score:
            ...
            self.score_text(30, f'{name}     {score}     {date:<5}', C_YELLOW,
